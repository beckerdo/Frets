...
public class NoteTest {
	...
	public void testEnum() {
		...
		assertTrue("Values", 6 == Note.Name.Ds.getValue());
	...
	public void testComparable() {
		...
		Note E2 = Note.parse( "E2" );
		Note B2 = Note.parse( "B2" );
		// System.out.println( "B2=" + B2.getAbsoluteValue() + ", E2=" + E2.getAbsoluteValue());
		assertTrue("B2 < E2", B2.compareTo(E2) < 0);
	}
	...
	public void testArithmetic() {
		...
		assertEquals("Guitar G", Note.GuitarG,
				Note.plus(Note.plus(Note.plus(Note.GuitarLowE, Interval.fourth), Interval.fourth), Interval.fourth));
		assertEquals("Guitar B", Note.GuitarB, Note.plus(
				Note.plus(Note.plus(Note.plus(Note.GuitarLowE, Interval.fourth), Interval.fourth), Interval.fourth),
				Interval.third));
		assertEquals("Guitar HighE", Note.GuitarHighE, Note.plus(Note.plus(
				Note.plus(Note.plus(Note.plus(Note.GuitarLowE, Interval.fourth), Interval.fourth), Interval.fourth),
		...
		assertEquals("Guitar G", Note.GuitarG,
				Note.minus(Note.minus(Note.GuitarHighE, Interval.fourth), Interval.third));
		assertEquals("Guitar D", Note.GuitarD,
				Note.minus(Note.minus(Note.minus(Note.GuitarHighE, Interval.fourth), Interval.third), Interval.fourth));
		assertEquals("Guitar A", Note.GuitarA, Note.minus(
				Note.minus(Note.minus(Note.minus(Note.GuitarHighE, Interval.fourth), Interval.third), Interval.fourth),
				Interval.fourth));
		assertEquals("Guitar LowE", Note.GuitarLowE, Note.minus(Note.minus(
				Note.minus(Note.minus(Note.minus(Note.GuitarHighE, Interval.fourth), Interval.third), Interval.fourth),
				Interval.fourth), Interval.fourth));
	}
	...
	public void testUnicode() {
		...
		// System.out.println(
		// "Unicode message=\u7686\u3055\u3093\u3001\u3053\u3093\u306b\u3061\u306f"
		// );
		// System.out.println(
		// "Unicode superscripts constant=\u2070\u00b9\u00b2\u00b3\u2074\u2075\u2076\u2077\u2078\u2079"
		// );
	...
	public void testStringParse() {
		...
		// System.out.println( name + " value=" + expected.getValue() +
		// ", octave=" + expected.getOctave() );
	...
	public void showCharsets() {
		...
		// Big5 CESU-8 COMPOUND_TEXT EUC-CN EUC-JP EUC-KR EUC-TW GB18030 GB2312
		// GBK hp-roman8
		// IBM-037 IBM-1006 IBM-1025 .. IBM-971
		// ISCII91 ISO-2022-CN ISO-2022-CN-GB ISO-2022-JP ISO-2022-KR
		// ISO-8859-1 ISO-8859-10 ISO-8859-13 ISO-8859-14 ISO-8859-15
		// ISO-8859-16
		// ISO-8859-2 ISO-8859-3 ISO-8859-4 ISO-8859-5 ISO-8859-6 ISO-8859-6S
		...
		// windows-1256S windows-1257 windows-1258 windows-31j windows-874
		// windows-936 windows-949 windows-950
	...
	public void showCoders() {
		...
		// System.out.println( "Char buffer=" + cbuf + ", length=" +
		// cbuf.length() );
		// ByteBuffer bbuf = encoder.encode( cbuf );
		// System.out.println( "Byte buffer=" + bbuf + ", length=" +
		// bbuf.array().length );
