...
public class FormulaListTest 
{
    ...
    public void testChordFormula() 
    {
		...
		NoteList expectedGMinor = new NoteList(Note.G, Note.As, Note.parse( "D1" ));		
    ...
    public void testScaleFormula() 
    {
		...
		NoteList expectedCPhrygian = new NoteList(Note.C, Note.Cs, Note.Ds, Note.F, Note.G, Note.Gs, Note.As);		
