...
public class NoteListTest {
	...
	public void testSorting() {
		NoteList bMajor = new NoteList(new Note[] { Note.plus(Note.GuitarB, Interval.seventh),
				Note.plus(Note.GuitarB, Interval.second), Note.plus(Note.GuitarB, Interval.octave),
				Note.plus(Note.GuitarB, Interval.fifth), Note.plus(Note.GuitarB, Interval.fourth), Note.GuitarB,
				Note.plus(Note.GuitarB, Interval.sixth), Note.plus(Note.GuitarB, Interval.third), });
	...
	public void testUpdateArithmetic() {
		NoteList standard = new NoteList(Note.GuitarLowE, Note.GuitarA, Note.GuitarD, Note.GuitarG, Note.GuitarB,
				Note.GuitarHighE);
	...
	public void testUpdateFormulas() {
		...
		assertEquals("B", Note.B.getValue(), major.get(1).getValue()); // next octave
		...
		assertEquals("B", Note.B.getValue(), major.get(2).getValue()); // next octave
		...
		assertEquals("A", Note.A.getValue(), minor.get(1).getValue());
		...
		assertEquals("A#", Note.As.getValue(), sus4.get(2).getValue());
	}

	@Test
	public void testIntervals() {
		// NoteList major = new NoteList(Note.C, Note.E, Note.G);
		NoteList major = new NoteList(Note.A, Note.Cs, Note.E);
		...
		NoteList minor = FsMinor.getAbsoluteIntervalNotes();
		...
		assertTrue("R", Interval.root.getValue() == minor.get(0).getAbsoluteValue() - Note.Fs.getAbsoluteValue());
		assertTrue("b3", Interval.minorThird.getValue() == minor.get(1).getAbsoluteValue() - Note.Fs.getAbsoluteValue());
		assertTrue("5", Interval.fifth.getValue() == minor.get(2).getAbsoluteValue() - Note.Fs.getAbsoluteValue());

		NoteList BbAug = new NoteList(Note.Bb, Note.plus(Note.Bb, Interval.third), Note.plus(Note.Bb,
				Interval.augmentedFifth));
		NoteList aug = BbAug.getAbsoluteIntervalNotes();
		// System.out.println("Bb aug notes=" + BbAug + ", absolute intervals=" + aug.toStringIntervals()
		// 		+ ", relative intervals=" + aug.toStringRelativeIntervals());
		assertTrue("R", Interval.root.getValue() == aug.get(0).getAbsoluteValue() - Note.Bb.getAbsoluteValue());
		assertTrue("3", Interval.third.getValue() == aug.get(1).getAbsoluteValue() - Note.Bb.getAbsoluteValue());
		assertTrue("#5", Interval.augmentedFifth.getValue() == aug.get(2).getAbsoluteValue() - Note.Bb.getAbsoluteValue());

		NoteList Adim = new NoteList(Note.A, Note.plus(Note.A, Interval.third), Note.plus(Note.A,
				Interval.diminishedFifth));
		// System.out.println("A dim notes=" + Adim + ", absolute intervals=" + Adim.toStringIntervals()
		// 		+ ", relative intervals=" + Adim.toStringRelativeIntervals());
		...
		NoteList absInt = Em.getAbsoluteIntervalNotes();
		System.out.println("Em notes=" + Em + ", absolute intervals=" + Em.toStringIntervals()
				+ ", relative intervals=" + Em.toStringRelativeIntervals());
		assertEquals("R", Interval.root.getValue(), absInt.get(0).getAbsoluteValue() - Note.E.getAbsoluteValue());
		assertEquals("b3", Interval.minorThird.getValue(), absInt.get(1).getAbsoluteValue() - Note.E.getAbsoluteValue());
		assertEquals("5", Interval.fifth.getValue(), absInt.get(2).getAbsoluteValue() - Note.E.getAbsoluteValue());
	}
