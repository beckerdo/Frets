...
public class DisplayTest 
{
    ...
    public void testDisplayPad()
    {
		...
		assertEquals("Pad BOTTOM RIGHT HORI", "   X", Display.pad( "X", 1, 4, VAlign.BOTTOM, 
			Hand.RIGHT, Orientation.HORIZONTAL, "", " " ));
		assertEquals("Pad TOP RIGHT HORI", "X   ", Display.pad( "X", 1, 4, VAlign.TOP, 
			Hand.RIGHT, Orientation.HORIZONTAL, "", " " ));
		assertEquals("Pad BOTTOM RIGHT HORI STRING", "---X", Display.pad( "X", 1, 4, VAlign.BOTTOM, 
			Hand.RIGHT, Orientation.HORIZONTAL, "-", " " ));
		assertEquals("Pad TOP RIGHT HORI STRING", "X---", Display.pad( "X", 1, 4, VAlign.TOP, 
			Hand.RIGHT, Orientation.HORIZONTAL, "-", " " ));
    	// Horizontal Left hand
		assertEquals("Pad BOTTOM LEFT HORI", "X  ", Display.pad( "X", 1, 3, VAlign.BOTTOM, 
			Hand.LEFT, Orientation.HORIZONTAL, "", " " ));
		assertEquals("Pad TOP LEFT HORI", "  X", Display.pad( "X", 1, 3, VAlign.TOP, 
			Hand.LEFT, Orientation.HORIZONTAL, "", " " ));
		assertEquals("Pad BOTTOM LEFT HORI STRING", "X--", Display.pad( "X", 1, 3, VAlign.BOTTOM, 
			Hand.LEFT, Orientation.HORIZONTAL, "-", " " ));
		assertEquals("Pad TOP LEFT HORI STRING", "--X", Display.pad( "X", 1, 3, VAlign.TOP, 
			Hand.LEFT, Orientation.HORIZONTAL, "-", " " ));
    	// Vertical Right hand
		assertEquals("Pad BOTTOM RIGHT VERT", " " + NL + " " + NL + "X" + NL, Display.pad( "X", 1, 3, VAlign.BOTTOM, 
			Hand.RIGHT, Orientation.VERTICAL, "", " " ));
		assertEquals("Pad TOP RIGHT VERT", "X " + NL + "  " + NL + "  " + NL, Display.pad( "X", 2, 3, VAlign.TOP, 
			Hand.RIGHT, Orientation.VERTICAL, "", " " ));
		assertEquals("Pad BOTTOM RIGHT VERT STRING", "|" + NL + "X" + NL, Display.pad( "X", 1, 2, VAlign.BOTTOM, 
			Hand.RIGHT, Orientation.VERTICAL, "|", " " ));
		assertEquals("Pad TOP RIGHT VERT STRING", "X " + NL + "| " + NL, Display.pad( "X", 2, 2, VAlign.TOP, 
			Hand.RIGHT, Orientation.VERTICAL, "|", " " ));
    	// Vertical LEFT hand
		assertEquals("Pad BOTTOM RIGHT VERT", " " + NL + " " + NL + "X" + NL, Display.pad( "X", 1, 3, VAlign.BOTTOM, 
			Hand.LEFT, Orientation.VERTICAL, "", " " ));
		assertEquals("Pad TOP RIGHT VERT", "X " + NL + "  " + NL + "  " + NL, Display.pad( "X", 2, 3, VAlign.TOP, 
			Hand.LEFT, Orientation.VERTICAL, "", " " ));
		assertEquals("Pad BOTTOM RIGHT VERT STRING", "|" + NL + "X" + NL, Display.pad( "X", 1, 2, VAlign.BOTTOM, 
			Hand.LEFT, Orientation.VERTICAL, "|", " " ));
    ...
    public void testDisplayPropertiesDefault()
    {
    	...
    	try {
    		...
    		// test.populateFromFile( "classpath:frets/main/displayDefault.properties" );
    		// test.populateFromFile( "file:frets/main/displayDefault.properties" );
        	...
        	Set<FretNumbering> fretNumbering = EnumSet.of( Display.FretNumbering.FIRSTLEFT, Display.FretNumbering.FIRSTRIGHT ); 
    ...
    public void testDisplayApertures() {
		...
		Fretboard fretboard = Fretboard.instance.getInstance( Fretboard.STANDARD ); // max fret 18
		...
		assertEquals("Fret span max location", locationsLow.maxFret() - locationsLow.minFret(), test.getDisplayAreaFretAperture() );
