...
public class FretboardTest 
{
    ...
    public void testVariations()
    {
        ...
        NoteList noteSet = new NoteList(
        	Note.GuitarG, // 4 locations,
        ...
        //    	System.out.println( "Variation " + i + ", locations=" + FilenameRegExFilter.getVariation( variations, i  ));
        LocationList expected = new LocationList( 
        	 new Location(0,0), new Location(0,5), new Location(0,15) );
        assertEquals( "Variations 0", expected, Fretboard.getPermutation( variations, 0));
        expected = new LocationList(
           	 new Location(0,0), new Location(0,5), new Location(1,10) );
        assertEquals( "Variations 1", expected, Fretboard.getPermutation( variations, 1));
        expected = new LocationList( 
           	 new Location(0,0), new Location(0,5), new Location(2,5) );
        assertEquals( "Variations 2", expected, Fretboard.getPermutation( variations, 2));
        expected = new LocationList( 
           	 new Location(0,0), new Location(1,0), new Location(3,0) );
        ...
        expected = new LocationList( 
           	new Location(0,0), new Location(0,5), new Location(3,0) );
        assertEquals( "Variations 2-1", expected, Fretboard.getPermutation( variations, 1));
        expected = new LocationList( 
           	new Location(0,0), new Location(1,0), new Location(2,5) );
    ...
    public void testVariationStrings()
    {
        ...
        // System.out.println( "NoteListTest null perm string=\"" + Fretboard.getPermutationString( null, 0 ) + "\".");
...
//        assertEquals("NoteList variation 16", "16/64 (100)", Fretboard.getPermutationString( variations, 16 ));
//        assertEquals("NoteList variation 62", "62/64 (332)", Fretboard.getPermutationString( variations, 62 ));
    ...
    public void testtoStringLocationsHorizontal()
    {
        ...
        assertEquals("FilenameRegExFilter horizontal plain righty",
        		none + nl +
        		head + note + space + space + space + nl +
        		none + nl +
        		none + nl +
        		head + space + space + note + space + nl +
        		none ,
        ...
        assertEquals("FilenameRegExFilter horizontal plain lefty",
        		none + nl +
        		space + space + space + note + head + nl +
        		none + nl +
        		none + nl +
        		space + note + space + space + head + nl + 
        		none,
            	standard.toString( cLocations, 0, 5, displayOpts ));        	
    }
    ...
    public void testtoStringNotesHorizontal()
    {
        ...
        assertEquals("FilenameRegExFilter horizontal plain righty",
        		none + nl +
        		played + note + space + space + space + nl +
        		none + nl +
        		none + nl +
        		played + space + space + note + space + nl +
        		none ,
            	standard.toString( cLocations, 0, 5, displayOpts ));        	
        ...
        assertEquals("FilenameRegExFilter horizontal plain righty",
        		none + nl +
        		space + space + space + note + played + nl +
        		none + nl +
        		none + nl +
        		space + note + space + space + played + nl + 
        		none,
            	standard.toString( cLocations, 0, 5, displayOpts ));        	
    }
    ...
    public void testtoStringHorizontalCompact()
    {
    	...
    	// System.out.println( standard.toString( cRootsPos0, 0, 5, displayOpts )); 
        assertEquals("FilenameRegExFilter horizontal named lefty",
        		none + nl +
        		space + space + space + note + played + nl +
        		none + nl +
        		none + nl +
    ...
    public void testtoStringHorizontalCompactNotPlayed()
    {
        ...
        assertEquals("FilenameRegExFilter horizontal plain righty compact not played",
        		none + nl +
        		c2 + nl +
        		none + nl +
        		none + nl +
    ...
    public void testtoStringHorizontalCompactNotPlayedFretNumbering()
    {
    	...
    	// System.out.println( "C roots 0 pos, righty, plain, compact not played, fret #s, Open: " );
    	// System.out.println( standard.toString( cRootsPos0, 0, 5, displayOpts ) );
        assertEquals("FilenameRegExFilter horizontal plain righty compact not played, open fret #s ",
        		none + nl +
        		c2 + nl +
        		none + nl +
        		none + nl +
        ...
        displayOpts.fretNumberingDisplayOpen = true;    	
       	fretNumber = "0";
        assertEquals("FilenameRegExFilter horizontal plain righty compact not played, no open fret #s ",
        		fretNumber + nl + 
        		none + nl +
        		c2 + nl +
        		none + nl +
       	...
       	none = "x----";
       	String c3 = "o----";
        // System.out.println( "C roots 1 pos, righty, plain, compact not played, fret #s: " );
    	// System.out.println( standard.toString( cRootsPos0, 3, 8, displayOpts ) );
        assertEquals("FilenameRegExFilter horizontal plain righty compact not played, fret #s ",
        		fretNumber + nl + 
        		none + nl +
        		none + nl +
        		none + nl +
    ...
    public void testtoStringVerticalCompact()
    {
    	...
    	// System.out.println( "C roots 0 pos, vertical, righty, plain, compact: " );
    	// System.out.println( standard.toString( cRootsPos0, 0, 5, displayOpts ) );
        assertEquals("FilenameRegExFilter vertical plain righty open strings",
        		head + nl +
        		nut + nl +
        		c1 + nl +
        		space + nl +
    	...
    	displayOpts.openStringDisplay = false;
       	head = "x xx x";
        assertEquals("FilenameRegExFilter vertical plain righty no open strings",
        		head + nl +
        		nut + nl +
        		c1 + nl +
        		space + nl +
    ...
    {
    	NoteList cRootsPos1 = new NoteList( 
			Note.plus( Note.GuitarA, Interval.wholehalf ),
			Note.plus( Note.GuitarG, Interval.fourth )
    	);
    	// Pick a variation for display. Will change if order changes.
    	...
    	// for ( int i = 0; i < varCount; i++ )
    	// 	System.out.println( "C locations variation " + i + ": " + FilenameRegExFilter.getVariation( cRootsPos1Vars, i ) );
    	...
    	// System.out.println( "C roots pos 1, vertical, righty, named, compact: " );
    	// System.out.println( standard.toStringVert( cRootsPos1, 3, 7, displayOpts ) );
        assertEquals("FilenameRegExFilter vertical plain righty",
        		c2 + nl +
        		space + nl +
        		c3 + nl +
        		space + nl,
    ...
    public void testtoStringVerticalNotesCompactNotPlayed()
    {
    	...
    	// System.out.println( "C roots pos 1, vertical, righty, named, compact, not played: " );
    	// System.out.println( standard.toString( cRootsPos1, 3, 6, displayOpts ) );
        assertEquals("FilenameRegExFilter vertical righty named compact not played",
        		c2 + nl +
        		space + nl +
        		c3 + nl,
    ...
    public void testtoStringVerticalNotesCompactNotPlayedFretNum()
    {
    	...
    	// System.out.println( "C roots pos 1, vertical, righty, named, compact, not played, fret num: " );
    	// System.out.println( standard.toString( cRootsPos1, 3, 6, displayOpts ) );
        assertEquals("FilenameRegExFilter vertical righty named compact not played fretnum, open string displayed",
        		c2 + nl +
        		space + nl +
        		c3 + nl,
            	standard.toString( cLocations, 3, 6, displayOpts ));        	
    ...
    public void testtoStringVariations()
    {
        ...
        // System.out.println( "G, string locations " + locations.size() + " locations: " + locations );
        // List<LocationList> variations = standard.getVariations( g3, 0, 18 );
        // System.out.println( "G, string variations " + FilenameRegExFilter.getVariationCount(variations) + " variations: " + variations );        
        // int variationCount = FilenameRegExFilter.getVariationCount(variations);
        // List<Location> variation0 = FilenameRegExFilter.getVariation(variations, 0);
    	// System.out.println( "G variation 0: " + standard.toString( variation0, 0, 18, displayOpts ) );
        ...
        assertEquals("FilenameRegExFilter vertical righty named compact not played fretnum",
        		fret + nl +
        		empty + nl +
        		empty + nl +
        		empty + nl +
    ...
    {
    	try {
    		String location = "src/main/resources/frets/main/fretboard.standard.properties";
    		Fretboard test = Fretboard.instance.readFromFile( location );

    		// Test meta data
    		assertEquals( "Name", "Standard", test.getMetaName());
    		assertEquals( "Description", "Standard, E-A-D-G-B-E", test.getMetaDescription());
    ...
    {
    	try {
    		String path = "src/main/resources/frets/main/";
    		String filter = "fretboard.*.properties";
    		List<Fretboard> fretboards = Fretboard.instance.readFromPath( path, filter );

    		assertEquals("FilenameRegExFilter prop file count", 6L, fretboards.size() );
...
//				assertEquals("Long name", "Standard E-A-D-G-B-E", test.getLongName());
//				assertEquals("Location", path, test.getLocation());
			}

    		filter = "fretboard.stan.*.properties";
    		fretboards = Fretboard.instance.readFromPath( path, filter );
    		assertEquals("FilenameRegExFilter prop file count", 4L, fretboards.size() );
    ...
    {
		Fretboard test = Fretboard.instance.getInstance( Fretboard.STANDARD );
		assertEquals( "Name", "Standard", test.getMetaName());
		assertEquals( "Description", "Standard, E-A-D-G-B-E", test.getMetaDescription());
		
		test = Fretboard.instance.getInstance( Fretboard.OPEN_D );
		assertEquals( "Name", "Open D", test.getMetaName());
		assertEquals( "Description", "Open D, D-A-D-G-B-E", test.getMetaDescription());
		
		test = Fretboard.instance.getInstance( Fretboard.OPEN_G );
